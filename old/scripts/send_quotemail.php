...
<table width='600' border='1' cellpadding='10' cellspacing='3'>
                              ...
                              <tr>
                                <td height='20' align='left' valign='top' class='form-titles' style='background-color:#EBEBEB; font-family:; font-family: Trebuchet MS, Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; Trebuchet MS; font-size:14px; color:#000; padding:10px 10px 5px 15px'>Estimated Budget / Cost</td>
                                <td align='left' valign='top' class='answers' style='background-color:#EBEBEB; font-family: Georgia, Times New Roman, Times, serif; font-size:13px; color:#666666; padding:10px 10px 5px 15px'>".$budget."</td>
                              </tr>
                              <tr>
                                <td height='20' align='left' valign='top' class='form-titles' style='background-color:#FFFFFF; font-family:; font-family: Trebuchet MS, Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; Trebuchet MS; font-size:14px; color:#000; padding:10px 10px 5px 15px'>Expected Time of Arrival</td>
                                <td align='left' valign='top' class='answers' style='background-color:#FFFFFF; font-family: Georgia, Times New Roman, Times, serif; font-size:13px; color:#666666; padding:10px 10px 5px 15px'>".$time."</td>
                              </tr>
                              <tr>
                                <td height='20' align='left' valign='top' class='form-titles' style='background-color:#EBEBEB; font-family:; font-family: Trebuchet MS, Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; Trebuchet MS; font-size:14px; color:#000; padding:10px 10px 5px 15px'>Comments</td>
                                <td align='left' valign='top' class='answers' style='background-color:#EBEBEB; font-family: Georgia, Times New Roman, Times, serif; font-size:13px; color:#666666; padding:10px 10px 5px 15px'>".$comments."</td>
                              </tr>
                            </table>
                            <br />
							</body>
			...
			$objMail->Subject = "Aeongrapix.com [ R Q ]";
			$objMail->IsHtml(true);
			$objMail->Body = $mail_body;	 
			$objMail->AddAddress("myselfanjan@gmail.com"); // Client's mail id
		//	$objMail->AddAddress($from); // Client's mail id
			$objMail->Send();
			
		    header('Location:../quote/index.php?stat=1');
